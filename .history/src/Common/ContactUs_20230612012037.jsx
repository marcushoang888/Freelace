...
export default function ContactUs() {
  ...
  return (
    ...
    >
      ...
      />
      {errors.name && <span className="f">This field is required</span>}
      <input
        className="group"
        type="text"
        placeholder="*Email"
      ...
      />
      {errors.email && <span className="f">This field is required</span>}
      ...
      />
      {errors.tel && <span className="f">This field is required</span>}
      ...
      ></textarea>
      {errors.message && <span className="f">This field is required</span>}

...
export default function NavBar() {
  ...
  return (
    <>
      {/* <nav className=" bg-black/20 text-white font-medium flex items-center justify-between px-10 py-2 ">
        <img
          src="/logo.png"
          alt=""
          className={`transition-all duration-[0.4s] ${navHeight} `}
        />
        <ul className=" text-[16px] flex gap-7 [&>li]:relative [&>li]:w-fit [&>li]:after:content-[''] [&>li]:after:block [&>li]:after:w-0 [&>li]:after:h-[3px] [&>li]:after:bg-white [&>li]:after:mx-auto hover:[&>li]:hover:after:w-full [&>li]:after:transition-all [&>li]:hover:transition-all [&>li]:after:duration-[0.8s] [&>li]:hover:duration-[0.8s]   [&>li]:after:absolute [&>li]:after:bottom-[-30%] uppercase [&>li>ul]:absolute [&>li>ul]:shadow-xl [&>li>ul]:w-[250px] [&>li>ul]:text-black [&>li>ul]:top-[150%] [&>li>ul]:bg-white [&>li>ul>li]:pl-6 [&>li>ul>li]:pr-2 [&>li>ul>li]:py-3  [&>li>ul]:flex-col   [&>li>ul]:text-sm hover:[&>li>ul>li]:hover:bg-black/20 [&>li>ul>li>a]:block [&>li>ul>li>a]:w-full ">
          <li>
            <Link>Trang chủ</Link>
          </li>
          <li>
      ...
      <div className="drawe fixed top-0 left-0 right-0 z-50r">

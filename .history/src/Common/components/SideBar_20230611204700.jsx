...
export default function SideBar() {
  ...
  return (
    <div className="  h-fit border  border-base-300 ">
      {categoryTypeQuery.data.map((type) => {
        return (
          <div className="collapse rounded-[0]  collapse-plus border-b-2 border-black/30  relative">
            ...
            <ul className="collapse-content  collapse-plus  p-0 [&>a]:block  [&>a]:border-b-2 [&>a]:rounded-[0] [&>a]:py-3 [&>a]:pl-9  list-disc hover:[&>a]:bg-slate-400/10 [&>a]:transition [&>a]:w-full ">

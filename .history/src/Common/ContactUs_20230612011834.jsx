...
export default function ContactUs() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className=" p-3 [&>.group]:border-blue-500 [&>.group]:border [&>.group]:my-3 [&>.group]:w-full  [&>.group]:h-10 focus:[&>.group]:outline-[#003d79] [&>.group]:pl-2  ">
      ...
      <input className="group" type="text" placeholder="Name"  {...register("name"),} />
      <input className="group" type="text" placeholder="*Email" {...register("email"),} />
      <input className="group" type="text" placeholder="Tel" {...register("tel"),}/>
      <textarea

            ...
            <Container>
                <div className='mt-[271px]'>
                    <ul className='list-disc list-outside px-[91px] text-sm text-black pt-[215px] pb-[43px] font-poppins leading-8'>
                                ...
                                <li>
                                    <p className='font-semibold inline'>Inactivated Vaccine Production Workshop</p>
                                    <p>
                                ...
                                <li>
                                    <p className='font-semibold inline'>Complete Equipment And Facilities</p>
                                    <p>
                                ...
                                <li>
                                    <p className='font-semibold inline'>Intelligent Manufacturing Park Completed</p>
                                    <p>

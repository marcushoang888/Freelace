        ...
        >
          {posts.map((post) => (
            <SwiperSlide key={post.imgUrl} className=" overflow-visible p-5 ">
              <div className=" relative group [&>div]:hover:transition-all [&>div]:hover:duration-[0.5s]  [&>div]:duration-[0.5s] [&>div]:transition-all cursor-pointer border-2 border-slate-200 h-[400px] relative rounded-lg overflow-hidden transition-all hover:transition-all  hover:shadow-xl hover:drop-shadow-xl hover:scale-105 hover:translate-y-[-10px]">
                <img
                  className=" w-full h-full object-cover rounded-lg   "
                  src={post.imgUrl}
                  alt=""
                />
                  <p className="  text-[25px] font-bold absolute">{post.title}</p>
                ...
                <div className=" px-5 absolute top-[100%] group-hover:top-0 text-white">

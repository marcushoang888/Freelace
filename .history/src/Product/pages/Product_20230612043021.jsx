...
export default function Product() {
  ...
  return (
    <>
      <div className="grid grid-cols-2 col-span-1 gap-7 md:grid-cols-3 md:col-span-[0] lg:col-span-3 lg:place-content-start">
        {Object.keys(products).length == 0 ? (
          <div className="place-self-center col-span-3 italic ">No items found</div>
        ) : (
          <>
            {" "}

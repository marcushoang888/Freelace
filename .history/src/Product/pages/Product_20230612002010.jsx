...
export default function Product() {
  ...
  return (
    <div className="grid grid-cols-2 lg:col-span-3   ">
      {Object.keys(products).length == 0 ? (
        <div className=" text-center col-span-2">No items found</div>
      ) : (
        <div className="grid gap-7 grid-cols-2 md:grid-cols-3 col-span-2">

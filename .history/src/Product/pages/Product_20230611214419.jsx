...
export default function Product() {
  ...
  if (Object.keys(queryObject).length != 0 && products ) {
    queryClient.setQueryData('products', products => [...products, products]);
    let NewProducts =  products.filter((product) => product.categories.includes(type));
  }

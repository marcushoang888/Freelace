...
export default function Product() {
  ...
  return (
    <div className="grid grid-cols-2">
      ...
      <div className="bg-pink-200  h-10"></div>
      <div className="bg-red   h-10"></div>
      <div className="bg-tellow-200  h-10"></div> <div className="bg-black   h-10"></div>
      <div className="bg-pink-200  h-10"></div> <div className="bg-black   h-10"></div>
      <div className="bg-pink-200  h-10"></div>
      {/* {Object.keys(products).length == 0 ? <div className=" text-center">No items found</div>
